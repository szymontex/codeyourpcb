...
# Figures stated in a comment that no test names, counted on 2026-09-06 - 35 on
# 2026-09-05, then 33 when a case quoted `soic8`'s block in its own header, and
# 32 once the preset tables were corrected and held. Each move was the ratchet
# refusing the commit that caused it until the number came with it. The
