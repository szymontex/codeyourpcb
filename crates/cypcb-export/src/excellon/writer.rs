...
pub fn export_excellon(
    ...
    output.push_str("; Plated Through Holes\n");
    ...
    let grouped_hits = group_hits_by_tool(&hits, &mut tool_table);
...
fn generate_empty_excellon() -> String {
    let mut output = String::new();
    output.push_str("M48\n");
    output.push_str("; DRILL file generated by CodeYourPCB\n");
    output.push_str("; No drill holes\n");
    output.push_str("METRIC,TZ\n");
    output.push_str("%\n");
    output.push_str("M30\n");
    output
...
mod tests {
    ...
    fn test_export_empty_board() {
        ...
        let result = export_excellon(&mut world, &library, &format).unwrap();
